...
<body>
    ...
    <main>
        ...
        <section class="result">
            <h2>Hey ${sellerName}, you are ${status} to ${operation}.</h2>
            ...
            %>
                        <meta http-equiv="refresh" content="5;url=register_seller.html">
            <%
                    } else {
            %>
                        <meta http-equiv="refresh" content="5;url=seller_login.html">
            <%
                    }
                } else {
            %>
            <meta http-equiv="refresh" content="5;url=sellerOptions.html">
            <%
                }
            %>
        </section>
